#!/usr/bin/env bash
# Pre-Release Validation Script for LASSO Regression Library
...
echo ""
echo "================================================"
echo "  LASSO Regression - Pre-Release Check"
echo "================================================"
echo ""
...
# 9. Gonum dependency check
log_info "Checking gonum dependency..."
GONUM_VERSION=$(grep "gonum.org/v1/gonum" go.mod | awk '{print $2}')
if [ -n "$GONUM_VERSION" ]; then
    log_success "gonum dependency: $GONUM_VERSION"
else
